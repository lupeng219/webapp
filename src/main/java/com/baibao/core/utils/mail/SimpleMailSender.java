...
public class SimpleMailSender {
     ...
     * @return void
     */
    public static void sendMailByTemplate(MailSenderInfo mailInfo,Map<String, String> map,String templateName) throws IOException,
     ...
     // 判断是否需要身份认证
     		...
     		try {
     			...
     			BodyPart html = new MimeBodyPart();
     			// 设置HTML内容
     			maiBody = EmailTemplateUtil.getProcessResult(map, templateName);
     			html.setContent(mailInfo.getContent()+maiBody, "text/html; charset=utf-8");
     			...
     			ex.printStackTrace();
     			logger.error("sendMailByTemplate", ex);
     		}
