...
public class Scaptcha {
	private static Logger logger = LoggerFactory.getLogger(Scaptcha.class);
    ...
    public void createCode() {  
        ...
        for (int i = 0; i < codeCount; i++) {  
            ...
            g.drawString(strRand, (i + 1) * codeX,  
                    /*getRandomNumber(height / 2) + 25*/30);  
    ...
    private Color getRandomColor() {  
        int r = getRandomNumber(1);  
        int g = getRandomNumber(1);  
        int b = getRandomNumber(1);  
