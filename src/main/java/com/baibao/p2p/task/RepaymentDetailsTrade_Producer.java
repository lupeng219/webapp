...
//@Component
public class RepaymentDetailsTrade_Producer implements Runnable{

	private static final Logger logger = LoggerFactory.getLogger(RepaymentDetailsTrade_Producer.class);
	
	@Autowired
	private RepaymentDetailsTrade_Storage storage;
	@Autowired
	private P2p_repayment_bill_trans_detailMapper p2p_repayment_bill_trans_detailMapper;
	
	public RepaymentDetailsTrade_Producer(){}
	public RepaymentDetailsTrade_Producer( RepaymentDetailsTrade_Storage storage ) {
	...
	public void producerHandler( )
	{
		...
		try{
			...
			suspiciousFlowList = p2p_repayment_bill_trans_detailMapper.querySuspiciousPaymentFlow();
		}catch(Exception e )
		{
