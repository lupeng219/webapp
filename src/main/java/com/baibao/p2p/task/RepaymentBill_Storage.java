 ...
 */
//@Component
public class RepaymentBill_Storage
{
	private static Logger logger = LoggerFactory.getLogger(RepaymentBill_Storage.class); 
	// 仓库最大容量
    private final int MAX_SIZE = 100;  
    // 仓库列表
    private LinkedBlockingQueue<Map<String, Object>> list =
    	new LinkedBlockingQueue<Map<String, Object>>(MAX_SIZE);  
