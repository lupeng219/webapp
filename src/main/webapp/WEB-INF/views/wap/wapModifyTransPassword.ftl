...
<body>
    <div class="wrap">
        ...
        <div class="form-txt">
            ...
            <div class="txt-cn">
                <input type="password" class="txt" placeholder="请输入新6位密码" id="newPass"/>
                <p class="err-p"></p>
            </div>
            <div class="txt-cn">
    ...
    <script type="text/javascript" charset="utf-8" src="${basePath}/js/wap/wapModifyTransPassword.js"></script>
</body>
</html>