...
$(function(){
    ...
    $ui_banklsit_li.on("click",function(){
        ...
        window.location.href=root+"/service/wapRecords/rechargeWithdraw?transType="+dataTemp;
    });
    ...
    $pageNo_a.on("click",function(){
    	if(!$(this).hasClass("notUse")){
            ...
            if(data){
            	window.location.href=root+"/service/wapRecords/rechargeWithdraw?transType="+transType+"&pageNum="+data;
            }else{
                return false;
            }
    	}
