    ...
    var d = document,
        ...
        _renderToolbox = function () {
            ...
            if (JIATHIS_CONFIGS.uid && wlh && !f) {
                ...
                if (g) {
                    creElm({
                        src: JIATHIS_CONFIGS.codehost+"/jiathis.html?uid=" + parseInt(JIATHIS_CONFIGS.uid) + "&dm=" + wlh,
                        charset: "utf-8"
                    }, "script")
                }
            }
            ...
            for (var i = 0, ci, tmp; ci = h[i++];) {
                ...
                if (ci.className && (tmp = ci.className.match(/^jiathis_like_(\w+)$/)) && tmp[1]) {
                    ...
                    if (likeid == 'qzone') {
                        ...
                        var t = jiathis_get_des(),
                            pic = '',
                            title = conf.title || document.title,
                            t = conf.summary == undefined ? t : conf.summary,
        ...
        clickpopjs, ckcpjs;
//    creElm({
//        href: JIATHIS_CONFIGS.codehost + "/jiathis_share.css",
//        rel: "stylesheet",
//        type: "text/css"
//    }, "link");
    $CKE = {
